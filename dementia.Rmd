...
When the model is used to predict the CDRs in the test dataset, it is 73.86% accurate. This is higher than the accuracy for the training set, proving there is little to no overfitting. Again, the P value is less than 0.05. 
...
```{r Random_Forest_Variable_Importance, fig.cap="rf-variable-importance"}
#Evaluate the variable importance
randomForest::varImpPlot(rf)
```
