...
When the model is used to predict the CDRs in the test dataset, it is 74.81% accurate. This is higher than the accuracy for the training set, proving there is little to no overfitting. Again, the P value is less than 0.05. 
