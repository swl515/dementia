...
The number of features used in the construction of each tree (mtry) needs to be optimised to reduce the out of bag (OOB) estimate of error rate. #run code and state which mtry have best OOb adn what it is :)
